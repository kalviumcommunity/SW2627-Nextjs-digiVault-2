...
async function GET(req) {
    try {
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuthService"].getAuthUser(req);
        if (!user) {
        ...
        const [totalDocuments, activeShareLinks, downloadsAggregate] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.count({
                where: {
                    userId: user.id
                }
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shareLink.count({
                where: {
                    userId: user.id,
                    isActive: true,
                    revokedAt: null,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.aggregate({
                where: {
                    userId: user.id
                },
                _sum: {
...
class AuthService {
   ...
   */ static generateToken(userId, mobileNumber) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0jdzryh._.js.map